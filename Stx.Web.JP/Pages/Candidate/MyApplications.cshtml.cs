...
{
    public class MyApplicationsModel : BasePageModel
    {
        private readonly ICandidateProfileDataService _dataService;

        public MyApplicationsModel(ICandidateProfileDataService dataService)
        {
            _dataService = dataService;
        }
        public string PageKey { get; set; } = "Applications";
